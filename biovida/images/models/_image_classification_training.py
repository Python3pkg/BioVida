...
def select_model():
    ...
    while model_to_use_no < 1 or model_to_use_no > len(models):
        model_to_use_no = int(eval(input("Please enter the number of "
...
save_name = eval(input("Please enter 'save name' for the output file: "))
epochs = int(eval(input("Please enter the number of epochs: ")))
